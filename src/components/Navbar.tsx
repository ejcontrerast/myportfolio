  ...
  return (
    <nav className="fixed top-0 z-50 shadow-md w-full flex justify-between items-center p-3 
      ...
      <div className="space-x-6 font-sans">
        <Link to="about" aria-label='' smooth={true} className="font-medium text-lg btns">About</Link>
        <Link to="projects" aria-label='' smooth={true} className="font-medium text-lg btns">Projects</Link>
        <Link to="contact" aria-label='' smooth={true} className="font-medium text-lg btns">Contact</Link>
      </div>
      ...
      <div className="flex items-center space-x-3">
        ...
        <svg
          ...
          onClick={() => window.open('https://www.linkedin.com/in/ejcontrerast', '_blank')}
        >
        ...
        <svg
          ...
          onClick={() => window.open('https://github.com/ejcontrerast', '_blank')}
        >
          <path d="M329 145h-432a40 40 0 0 0-40 40v432a40 40 0 0 0 40 40h432a40 40 0 0 0 40-40V185a40 40 0 0 0-40-40zm10 472a10 10 0 0 1-10 10h-432a10 10 0 0 1-10-10V185a10 10 0 0 1 10-10h432a10 10 0 0 1 10 10v432z" />
