...
import { ReactComponent as Logo } from '../assets/eclogo.svg';
import { ReactComponent as LogoName } from '../assets/namelogo.svg';
    ...
    <nav className="fixed top-0 z-50 shadow-md w-full flex justify-between items-center p-3 
      ...
      <Link to="hello" smooth={true} offset={-70} className="cursor-pointer">
        <div className="font-thin flex dark:fill-dark-accent fill-light-primary">
          {/* Logo - SVG */}
          <Logo className="w-8 h-8 dark:text-dark-accent text-light-primary" />
          {/* Logo Name - SVG */}
          <LogoName className="w-36 h-8 dark:text-dark-accent text-light-primary sm:block hidden" />
        </div>
      </Link>

      {/* Internal Links */}
      <div className="space-x-6 font-sans">
        <Link to="about" smooth={true} className="font-medium text-lg btns">About</Link>
        <Link to="projects" smooth={true} className="font-medium text-lg btns">Projects</Link>
        <Link to="contact" smooth={true} className="font-medium text-lg btns">Contact</Link>
      </div>
      ...
      <div className="flex items-center space-x-3">
        ...
        <svg
          ...
          className="h-7 btns-icons hidden sm:block"
        >
