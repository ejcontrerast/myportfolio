  ...
  return (
    <nav className="fixed top-0 z-50 shadow-md w-full flex justify-between items-center p-3 
      ...
      <Link to="hello" smooth={true} offset={-70} className="cursor-pointer">
        <div className="font-thin flex dark:fill-dark-accent fill-light-primary">
          <svg
      ...
      <div className="space-x-6 font-sans">
        <Link to="about" smooth={true} className="cursor-pointer font-medium text-lg dark:text-dark-accent text-light-primary hover:text-dark-accent dark:hover:text-light-primary">About</Link>
        <Link to="projects" smooth={true} className="cursor-pointer font-medium text-lg dark:text-dark-accent text-light-primary hover:text-dark-accent dark:hover:text-light-primary">Projects</Link>
        <Link to="contact" smooth={true} className="cursor-pointer font-medium text-lg dark:text-dark-accent text-light-primary hover:text-dark-accent dark:hover:text-light-primary">Contact</Link>
      </div>
      ...
      <div className="flex items-center space-x-3">
        ...
        <svg
          ...
          className="h-7 cursor-pointer dark:fill-dark-accent fill-light-primary hidden sm:block dark:hover:fill-dark-secondary hover:fill-light-accent"
        >
